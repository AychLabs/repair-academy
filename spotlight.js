...
const spotlightTasks = [
  { instruction: "OPEN SPOTLIGHT", prompt: "On a real Mac, press Command + Space to open Spotlight. For this training simulation, click the Spotlight icon in the Menu Bar. Then find and open Calculator.", target: "app-calculator", hint: "Click the Search icon in the simulated Menu Bar, then search for Calculator.", feedback: "Spotlight can launch applications without finding them in the Dock or Applications folder." },
...
function setSpotlightOpen(open) {
  ...
  if (open) {
    ...
    if (!s.taughtShortcut) {
      ...
      spotlightApp.querySelector("#spotlight-feedback").textContent = "Spotlight is open. Find and open Calculator.";
    }
